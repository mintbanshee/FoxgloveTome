...
<div class="container py-4">
    ...
    <div class="userCard card shadow-sm">
        <div class="card-body">
            ...
            <p class="mb-2">
                <strong>Total Entries:</strong> <?= htmlspecialchars((string) $entryCount) ?>
            </p>

            <!--*~*~*~*   User's Dominant Mood This Week / No Mood Logged This Week    *~*~*~*-->
            <p class="mb-2">
            ...
            <!--*~*~*~*   View User's Garden    *~*~*~*-->
            <!-- This will be useful in the future for curating seeds for seed shop orders while respecting user privacy -->
            <div class="mt-3">
                <p class="mb-2">
                ...
                <div class="d-flex gap-2 justify-content-center flex-wrap">
                    <a href="<?= BASE_URL ?>views/users/garden.php?id=<?= htmlspecialchars((string)$user['user_id']) ?>"
