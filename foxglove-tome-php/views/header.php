...
<head>
  ...
  <meta 
    name="description" 
    content="The Foxglove Tome is a digital sanctuary for reflection, mood tracking, and emotional wellness through journaling and garden visualization."
  >
  ...
  <link 
    rel="icon" 
    type="image/png" 
    href="<?php echo BASE_URL; ?>assets/images/Favicon48.png"
  >
  ...
  <div class="container-fluid">
    ...
    <div class="ms-auto">
      ...
      <a href="<?= BASE_URL ?>views/users/user_dashboard.php">
        <img src="<?php echo BASE_URL; ?>assets/images/icons/AccountWhite100.png"
             alt="Dashboard"
             width="40" height="40">
      </a>
    </div>
