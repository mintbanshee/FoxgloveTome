            ...
            <div class="entryFormCard card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="<?= BASE_URL ?>controllers/entry_controller.php?action=update_entry" method="POST">
                      <input type="hidden" name="entry_id" value="<?= htmlspecialchars((string)$entry['entry_id']) ?>">
                    ...
                    <input type="hidden"
                        ...
                        <!-- Mood dropdown -->
                         <!-- The mood dropdown is populated dynamically based on the selected category -->
                        <div class="mb-4">
...
<!--*~*~*~*   Script for Dynamic Mood Selection   *~*~*~*-->
